...
import static com.example.n20dccn143_levietthanh.activities.ProductListActivity.getProductList;
...
public class ProductEditingActivity extends AppCompatActivity {
    ...
    protected void setEvent() {
        ...
        Log.i("TAGTAG", ""+(categoryList.get(1).getCategory_name()));
    ...
    private void editProduct( ) {
        ...
        try {
            ...
            jsonData.put("price", String.valueOf(etProductPrice.getText()));
        ...
        if (selectedImageUri == null){
            imagePart = MultipartBody.Part.createFormData(Const.KEY_FILE, "", RequestBody.create(null, new byte[0]));
            ...
            imagePart = MultipartBody.Part.createFormData(Const.KEY_FILE, file.getName(), requestFile);
        }
        ...
        apiService.updateProduct(tokenStaff, productId, imagePart, requestBody).enqueue(new Callback<ApiResponse>() {
            ...
            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (result != null){
                        Toast.makeText(ProductEditingActivity.this, "Sửa sản phẩm thành công", Toast.LENGTH_SHORT).show();
                        mProgressDialog.dismiss();
                    ...
                    Toast.makeText(ProductEditingActivity.this,"loi", Toast.LENGTH_SHORT).show();
                    System.out.println("LOI TRA VE");
                }
            }
            @Override
    ...
    public void getProductDetail(String product_id){
        apiService.getProductDetail(tokenUser, product_id).enqueue(new Callback<Product>() {
            @Override
            public void onResponse(Call<Product> call, Response<Product> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    if (product2 != null){
                        ...
                        etProductPrice.setText(String.valueOf(product2.getPrice_update_detail()[0].getPrice_new()));
                        etDescription.setText(product2.getDescription());
                        Picasso.get()
                                .load(product2.getProductImg())    //load(url)
                                .into(ivProductImg);    //into(variant)
                        Log.i("QQQQQQQQ", ""+product2.getProductCategories().getCategory_name());
                        ...
                        spnCategoryOption2.setSelection(getCategoryPosition(product2.getProductCategories().getCategory_name()));
